...
public class LoadoutList extends Command{
	...
	public CommandResponse execute(Player player, Set<String> flags, Map<String, Object> parameters, List<Object> baseParameters)
		...
		List<String> loadouts = CVPvp.getInstance().getLoadoutManager().getLoadoutNames();
		...
		if (parameters.containsKey("sub") && !parameters.containsKey("tags")) {
			...
			loadouts = CVPvp.getInstance().getLoadoutManager().getLoadoutNamesByTags((List<String>) parameters.get("tags"));
		}
