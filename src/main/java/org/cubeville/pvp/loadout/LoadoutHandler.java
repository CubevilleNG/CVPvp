...
public class LoadoutHandler {
    ...
    public static boolean applyLoadoutFromSign(Player player, Sign sign) {		
        LoadoutContainer lc = CVPvp.getInstance().getLoadoutManager().getLoadoutByName(sign.getLine(2));
    ...
    public static void cloneInventoryToLoadout(Player player, LoadoutContainer lc, String team) {
        ...
        CVPvp.getInstance().getConfig().set("LoadoutManager", CVPvp.getInstance().getLoadoutManager());
        CVPvp.getInstance().saveConfig();
    }
